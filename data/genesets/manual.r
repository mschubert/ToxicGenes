...
sets = list(
    ...
    Cosmic_OG_Hallmark = cosmic_og %>% filter(Hallmark == "Yes") %>% pull(`Gene Symbol`),
    Cosmic_TSG_Hallmark = cosmic_tsg %>% filter(Hallmark == "Yes") %>% pull(`Gene Symbol`),
    ...
    Cosmic_OG_only = setdiff(cosmic_og$`Gene Symbol`, cosmic_tsg$`Gene Symbol`),
    Cosmic_TSG_only = setdiff(cosmic_tsg$`Gene Symbol`, cosmic_og$`Gene Symbol`),
